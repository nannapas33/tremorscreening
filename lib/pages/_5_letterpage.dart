...
import 'package:tremorscreeningv2/pages/_5.5_THletterpage.dart';
...
class LetterPage extends StatefulWidget {
  ...
  static var lhwlTS, rhwlTS = [];
  static var lhwlCO, rhwlCO = [];
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: PreferredSize(
        ...
        title: Text('Letter Writing',style: TextStyle(fontSize: _fontsize)),
      ),),
      body: Center(
        child: Container(
          width: _wgif,
          decoration: BoxDecoration(
            image: DecorationImage(
              ...
              image: AssetImage('assets/image/letters.gif'),
            ),
          ),
        ),
        ),
  ...
  Widget float2() {
    return Container(
      child: FloatingActionButton(
        ...
        onPressed: () {
          _showConfirmDialog();
          LetterPage.rhwlTS = timeStamp;
          LetterPage.rhwlCO = coordn;
        },
        heroTag: "btn2",
                    ...
                    children: <Widget>[
                      Container(
                        ...
                        decoration: BoxDecoration(
                          image: DecorationImage(
                            fit: BoxFit.fitWidth,
                            image: AssetImage('assets/image/letters_template.jpg'),
  ...
  Widget float2() {
    return Container(
      child: FloatingActionButton(
        ...
        onPressed: () {
          _showConfirmDialog();
          LetterPage.lhwlTS = timeStamp;
          LetterPage.lhwlCO = coordn;
        },
        heroTag: "btn2",
        tooltip: 'Second button',
        child: Icon(Icons.check),
        ...
        builder: (BuildContext) {
          return AlertDialog(
              ...
              actions: <Widget>[
                ...
                TextButton(
                    onPressed: () {
                      uploadImg(_LWLkey, "LWL");
                      Navigator.push(context,
                          MaterialPageRoute(builder: (context) => THLettersPage()));
                    },
                    child: Text('ใช่',
                        style: TextStyle(
                            fontSize: _fontsize, color: Colors.red[900])))
